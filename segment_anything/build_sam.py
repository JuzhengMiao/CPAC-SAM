...
from .modeling import ImageEncoderViT, MaskDecoder, MaskDecoder_prompt_large, PromptEncoder, PromptEncoder_prompt_class, Sam, TwoWayTransformer, Sam_dualmask_same_prompt_class_random_large, Sam_dualmask_same_prompt_class_random_large_labelguide_PCR2_3
...
def build_sam_vit_b_dualmask_same_prompt_class_random_large_labelguide_PCR2_3(image_size, num_classes, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
                    checkpoint=None):
    return _build_sam_dualmask_same_prompt_class_random_large_labelguide_PCR2_3(
        encoder_embed_dim=768,
        encoder_depth=12,
        encoder_num_heads=12,
        encoder_global_attn_indexes=[2, 5, 8, 11],
...
sam_model_registry = {
    ...
    "vit_b_dualmask_same_prompt_class_random_large": build_sam_vit_b_dualmask_same_prompt_class_random_large,
    "vit_b_dualmask_same_prompt_class_random_large_labelguide_PCR2_3": build_sam_vit_b_dualmask_same_prompt_class_random_large_labelguide_PCR2_3,
}
...
def _build_sam_dualmask_same_prompt_class_random_large(
    ...
    sam = Sam_dualmask_same_prompt_class_random_large(
...
def _build_sam_dualmask_same_prompt_class_random_large_labelguide_PCR2_3(
        encoder_embed_dim,
        encoder_depth,
        encoder_num_heads,
        encoder_global_attn_indexes,
    ...
    vit_patch_size = 16
    image_embedding_size = image_size // vit_patch_size  # Divide by 16 here
    sam = Sam_dualmask_same_prompt_class_random_large_labelguide_PCR2_3(
        image_encoder=ImageEncoderViT(
            depth=encoder_depth,
            embed_dim=encoder_embed_dim,
            img_size=image_size,

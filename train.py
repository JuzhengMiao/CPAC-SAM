...
from trainer_dualmask import trainer_acdc_dualmask_prompt_ssl_fixcoe_up_labelguide_PCR2_3_PCR
...
parser.add_argument('--vit_name', type=str,
                    default='vit_b_dualmask_same_prompt_class_random_large_labelguide_PCR2_3', help='select one vit model')
parser.add_argument('--ckpt', type=str, default='xxx/sam_vit_b_01ec64.pth',
                    help='Pretrained checkpoint')   # Put the path to the original SAM checkpoint here
...
parser.add_argument('--module', type=str, default='sam_lora_image_encoder_prompt_labelguide')
...
parser.add_argument('--method', type=str, default='A40_labelguide_scaling_PCR2_3_PCR_withloss_c10')
parser.add_argument('--promptmode', type=str, default='point',help='prompt')
parser.add_argument('--scaling', default=[8, 16],help='scaling')
...
parser.add_argument('--coe_PCR', type=float,
                    default=0.005, help='coe')
...
if __name__ == "__main__":
    ...
    snapshot_path += '_scaling' + str(args.scaling)
    ...
    trainer = {'ACDC': trainer_acdc_dualmask_prompt_ssl_fixcoe_up_labelguide_PCR2_3_PCR}

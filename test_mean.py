...
if __name__ == '__main__':
    ...
    parser.add_argument('--vit_name', type=str, default='vit_b_dualmask_same_prompt_class_random_large_labelguide_PCR2_3', help='Select one vit model')
    ...
    parser.add_argument('--scaling1', type=int, default=8,help='scaling')
    parser.add_argument('--scaling2', type=int, default=16,help='scaling')
